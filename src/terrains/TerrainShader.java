...
public class TerrainShader extends ShaderProgram{
	...
	private int location_shineDampers[];
	private int location_reflectivitys[];
	...
	protected void getAllUniformLocations() {
		...
		location_shineDampers = new int[4];
		location_reflectivitys = new int[4];
		for(int i = 0; i < 4; i++){
			location_shineDampers[i] = super.getUniformLocation("shineDampers[" + i + "]");
			location_reflectivitys[i] = super.getUniformLocation("reflectivitys[" + i + "]");
		}
	...
	public void loadShineVariables(float[] damper, float[] reflectivity){
		for(int i = 0; i < 4; i++){
			super.loadFloat(location_reflectivitys[i], reflectivity[i]);
			super.loadFloat(location_shineDampers[i], damper[i]);
		}
	}
